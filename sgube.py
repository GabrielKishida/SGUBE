...
def loanQuery(person, device):
    ...
    if device == "Equipamento":
        ...
        print("Algo deu errado em loanQuery")
        return("")
    query += "from ((((" + person + " "
    ...
    query += "INNER JOIN tipo" + device + " ON " + device + ".tipo" + device + "_idtipo" + device + " = tipo" + device + ".idtipo" + device + ") "
    return query
...
database = [pd.read_csv(os.path.join(__location__, "alunos.csv")),
            ...
            pd.read_csv(os.path.join(__location__, "Aluno_has_Aparato.csv")),
            pd.read_csv(os.path.join(__location__, "Professor_has_Aparato.csv")),
            pd.read_csv(os.path.join(__location__, "Funcionario_has_Aparato.csv"))
]

entity = ["Aluno", "Professor", "Trabalha_Em", "Responsavel_Por", "Livro", "Laboratorio", "Funcionario", 
          "tipoEquipamento", "Equipamento", "tipoLivro", "Laboratorio_has_Aparato", "Biblioteca_has_Aparato", "Biblioteca", 
          "Aparato", "Aluno_has_Aparato","Professor_has_Aparato","Funcionario_has_Aparato"
]
